...
const Header = ({ isLoggedIn = false, user = null, onLogin, onLogout }) => {
  ...
  return (
    <header className="sticky top-0 z-50 shadow-lg border-b border-gray-200 overflow-x-hidden" style={{ background: '#ffffff', color: '#1f2937' }}>
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <div className="flex items-center h-16 md:h-18 gap-6 lg:gap-8">
          {/* Logo & Brand */}
          <div 
          ...
          <nav className={`hidden lg:flex items-center space-x-6 xl:space-x-8 flex-1 ml-4 nav-items-fade ${searchExpanded ? 'hidden' : ''}`}>
