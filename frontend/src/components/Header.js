  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 shadow-sm border-b border-gray-200" style={{ background: '#ffffff', color: '#1f2937', height: '72px' }}>
        <div className="max-w-[1600px] mx-auto h-full px-4 md:px-6 lg:px-6 xl:px-10">
          <div className="flex items-center h-full gap-3 lg:gap-4 xl:gap-6">
            {/* ────────── LEFT: Logo & Brand ────────── */}
            <div
            ...
            <nav className="hidden lg:flex flex-1 items-center justify-center gap-1.5 xl:gap-3 min-w-0" aria-label="Primary">
              ...
              {/* "More ▾" — Hidden on lg and above desktops */}
              <div className="relative lg:hidden" data-more-menu-container>
                <button
                  type="button"
                  onClick={() => setMoreOpen((v) => !v)}
                  className="inline-flex flex-shrink-0 items-center gap-1 whitespace-nowrap px-2 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 transition-colors rounded-md hover:bg-gray-100"
                  aria-haspopup="menu"
