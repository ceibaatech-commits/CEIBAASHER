        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border-2 border-blue-200">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {inputMethod === 'manual' ? (
              ...
              <div className="space-y-5 bg-green-50 p-5 rounded-xl border border-green-200">
          ...
          <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="text-sm text-gray-600">
                Showing {indexOfFirstSheet + 1} to {Math.min(indexOfLastSheet, filteredSheets.length)} of {filteredSheets.length} sheets
