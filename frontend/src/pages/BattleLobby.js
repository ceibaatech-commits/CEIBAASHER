...
const BATTLE_SERVER_URL = process.env.REACT_APP_BACKEND_URL || 'https://socialeq-hub.preview.emergentagent.com';
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            <div className="bg-gradient-to-r from-purple-300 to-pink-300 text-white w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      <div className="bg-gradient-to-r from-blue-300 to-indigo-300 text-white w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg">
