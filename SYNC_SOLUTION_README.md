...
### Test API Endpoint
```bash
curl https://multilingual-quiz-2.preview.emergentagent.com/api/exam-metadata | jq
```

### Test Specific Exam
```bash
curl https://multilingual-quiz-2.preview.emergentagent.com/api/exam-metadata/CAPF | jq
```
