...
### Test API Endpoint
```bash
curl https://socialfeed-fixes.preview.emergentagent.com/api/exam-metadata | jq
```

### Test Specific Exam
```bash
curl https://socialfeed-fixes.preview.emergentagent.com/api/exam-metadata/CAPF | jq
```
