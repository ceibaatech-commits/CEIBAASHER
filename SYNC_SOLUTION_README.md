...
### Test API Endpoint
```bash
curl https://mobile-search-fix-1.preview.emergentagent.com/api/exam-metadata | jq
```

### Test Specific Exam
```bash
curl https://mobile-search-fix-1.preview.emergentagent.com/api/exam-metadata/CAPF | jq
```
