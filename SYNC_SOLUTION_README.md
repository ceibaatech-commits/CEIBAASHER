...
### Test API Endpoint
```bash
curl https://exam-crud-admin.preview.emergentagent.com/api/exam-metadata | jq
```

### Test Specific Exam
```bash
curl https://exam-crud-admin.preview.emergentagent.com/api/exam-metadata/CAPF | jq
```
