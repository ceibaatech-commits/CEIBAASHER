...
### Test API Endpoint
```bash
curl https://profile-followers.preview.emergentagent.com/api/exam-metadata | jq
```

### Test Specific Exam
```bash
curl https://profile-followers.preview.emergentagent.com/api/exam-metadata/CAPF | jq
```
