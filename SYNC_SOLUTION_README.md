...
### Test API Endpoint
```bash
curl https://study-exam-makeover.preview.emergentagent.com/api/exam-metadata | jq
```

### Test Specific Exam
```bash
curl https://study-exam-makeover.preview.emergentagent.com/api/exam-metadata/CAPF | jq
```
