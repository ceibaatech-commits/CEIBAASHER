...
### Test API Endpoint
```bash
curl https://exprep-mobile-ui.preview.emergentagent.com/api/exam-metadata | jq
```

### Test Specific Exam
```bash
curl https://exprep-mobile-ui.preview.emergentagent.com/api/exam-metadata/CAPF | jq
```
