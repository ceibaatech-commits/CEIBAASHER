...
### Test API Endpoint
```bash
curl https://syllabus-sync-3.preview.emergentagent.com/api/exam-metadata | jq
```

### Test Specific Exam
```bash
curl https://syllabus-sync-3.preview.emergentagent.com/api/exam-metadata/CAPF | jq
```
