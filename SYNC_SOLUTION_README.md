...
### Test API Endpoint
```bash
curl https://quiz-navigation.preview.emergentagent.com/api/exam-metadata | jq
```

### Test Specific Exam
```bash
curl https://quiz-navigation.preview.emergentagent.com/api/exam-metadata/CAPF | jq
```
