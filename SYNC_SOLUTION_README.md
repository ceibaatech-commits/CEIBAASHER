...
### Test API Endpoint
```bash
curl https://post-animation-test.preview.emergentagent.com/api/exam-metadata | jq
```

### Test Specific Exam
```bash
curl https://post-animation-test.preview.emergentagent.com/api/exam-metadata/CAPF | jq
```
