...
### Test API Endpoint
```bash
curl https://podcast-tutor-1.preview.emergentagent.com/api/exam-metadata | jq
```

### Test Specific Exam
```bash
curl https://podcast-tutor-1.preview.emergentagent.com/api/exam-metadata/CAPF | jq
```
