...
### Test API Endpoint
```bash
curl https://ceibaa-integration.preview.emergentagent.com/api/exam-metadata | jq
```

### Test Specific Exam
```bash
curl https://ceibaa-integration.preview.emergentagent.com/api/exam-metadata/CAPF | jq
```
