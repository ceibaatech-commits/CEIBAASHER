...
### Test API Endpoint
```bash
curl https://test-history-board.preview.emergentagent.com/api/exam-metadata | jq
```

### Test Specific Exam
```bash
curl https://test-history-board.preview.emergentagent.com/api/exam-metadata/CAPF | jq
```
