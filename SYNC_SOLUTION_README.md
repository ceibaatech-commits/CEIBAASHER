...
### Test API Endpoint
```bash
curl https://quiz-consistency-fix.preview.emergentagent.com/api/exam-metadata | jq
```

### Test Specific Exam
```bash
curl https://quiz-consistency-fix.preview.emergentagent.com/api/exam-metadata/CAPF | jq
```
