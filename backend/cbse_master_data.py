"""
CBSE Master Data - Single Source of Truth
All subjects and chapters for Classes 6-12
This is the ONLY place where CBSE syllabus data should be defined.
"""

CBSE_SUBJECTS = {
    "6": [
        {"name": "Mathematics - Ganita Prakash", "slug": "mathematics---ganita-prakash", "icon": "Calculator", "color": "from-blue-500 to-blue-600"},
        {"name": "Hindi - Malhar", "slug": "hindi---malhar", "icon": "BookOpen", "color": "from-orange-500 to-orange-600"},
    ...
    "8": [
        ...
        {"name": "English - Poorvi", "slug": "english---poorvi", "icon": "Languages", "color": "from-purple-500 to-purple-600"},
        {"name": "Science - Curiosity", "slug": "science---curiosity", "icon": "Flask", "color": "from-teal-500 to-teal-600"},
        {"name": "Geography", "slug": "geography", "icon": "Map", "color": "from-teal-500 to-teal-600"},
        {"name": "Social Science - Exploring Society: India and Beyond", "slug": "social-science---exploring-society:-india-and-beyond", "icon": "Globe", "color": "from-amber-500 to-amber-600"},
        {"name": "Sanskrit - Sulabha", "slug": "sanskrit---sulabha", "icon": "Scroll", "color": "from-red-500 to-red-600"},
    ],
    "9": [
        {"name": "Mathematics", "slug": "mathematics", "icon": "Calculator", "color": "from-blue-500 to-blue-600"},
        {"name": "Science", "slug": "science", "icon": "Beaker", "color": "from-green-500 to-green-600"},
        {"name": "Hindi Kshitij", "slug": "hindi-kshitij", "icon": "BookOpen", "color": "from-orange-500 to-orange-600"},
        {"name": "English Beehive", "slug": "english-beehive", "icon": "Languages", "color": "from-purple-500 to-purple-600"},
        {"name": "English Moments", "slug": "english-moments", "icon": "Languages", "color": "from-violet-500 to-violet-600"},
        {"name": "Geography", "slug": "geography", "icon": "Map", "color": "from-teal-500 to-teal-600"},
    ...
    "10": [
        ...
        {"name": "Science", "slug": "science", "icon": "Beaker", "color": "from-green-500 to-green-600"},
        {"name": "Hindi Kshitij", "slug": "hindi-kshitij", "icon": "BookOpen", "color": "from-orange-500 to-orange-600"},
        {"name": "English First Flight", "slug": "english-first-flight", "icon": "Languages", "color": "from-purple-500 to-purple-600"},
        {"name": "English Footprints Without Feet", "slug": "english-footprints-without-feet", "icon": "Languages", "color": "from-violet-500 to-violet-600"},
        {"name": "Geography", "slug": "geography", "icon": "Map", "color": "from-teal-500 to-teal-600"},
        {"name": "History", "slug": "history", "icon": "Landmark", "color": "from-yellow-500 to-yellow-600"},
        {"name": "Civics", "slug": "civics", "icon": "Scale", "color": "from-indigo-500 to-indigo-600"},
        {"name": "Economics", "slug": "economics", "icon": "TrendingUp", "color": "from-emerald-500 to-emerald-600"},
    ...
    "11_science": [
        ...
        {"name": "Chemistry", "slug": "chemistry", "icon": "Flask", "color": "from-green-500 to-green-600"},
        {"name": "Mathematics", "slug": "mathematics", "icon": "Calculator", "color": "from-purple-500 to-purple-600"},
        {"name": "Biology", "slug": "biology", "icon": "Dna", "color": "from-pink-500 to-pink-600"},
        {"name": "English", "slug": "english", "icon": "Languages", "color": "from-orange-500 to-orange-600"},
    ],
    "11_commerce": [
        {"name": "Accountancy", "slug": "accountancy", "icon": "Calculator", "color": "from-blue-500 to-blue-600"},
        {"name": "Business Studies", "slug": "business-studies", "icon": "Briefcase", "color": "from-green-500 to-green-600"},
        {"name": "Economics", "slug": "economics", "icon": "TrendingUp", "color": "from-purple-500 to-purple-600"},
...
CBSE_CHAPTERS = {
    ...
    "9": {
        ...
        "science": [
            ...
            "4. Structure of the Atom", "5. The Fundamental Unit of Life", "6. Tissues", "7. Motion",
    ...
    "10": {
        "mathematics": [
            ...
            "4. Quadratic Equations", "5. Arithmetic Progressions", "6. Triangles", "7. Coordinate Geometry",
            "8. Introduction to Trigonometry", "9. Some Applications of Trigonometry", "10. Circles",
            "11. Areas Related to Circles", "12. Surface Areas and Volumes", "13. Statistics", "14. Probability"
        ],
        "science": [
    ...
    "11_science": {
        ...
        "english": [
            ...
            "4. Landscape of the Soul", "5. The Ailing Planet", "6. The Browning Version",
            "7. The Adventure", "8. Silk Road"
        ],
    },
    "11_commerce": {
        "accountancy": [
    ...
    "12_commerce": {
        ...
        "business-studies": [
            ...
            "4. Planning", "5. Organising", "6. Staffing", "7. Directing", "8. Controlling",
...
def get_subjects_for_class(class_num: str, stream: str = None) -> list:
    """Get subjects for a class, optionally with stream for 11 and 12"""
    if class_num in ["11", "12"] and stream:
        key = f"{class_num}_{stream}"
    else:
        key = class_num
    return CBSE_SUBJECTS.get(key, [])
...
def get_all_cbse_data() -> dict:
    """Get all CBSE data for admin panel"""
    return {
