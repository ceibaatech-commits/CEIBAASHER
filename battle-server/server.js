...
const io = new Server(httpServer, {
  cors: {
    origin: process.env.CORS_ORIGINS ? process.env.CORS_ORIGINS.split(',') : ['http://localhost:3000', 'http://localhost:8000', 'https://exam-practice-app-1.preview.emergentagent.com'],
    methods: ['GET', 'POST'],
    credentials: true
  },
  path: '/socket.io/',
