...
5. **Authorized JavaScript origins**: Add
   ```
   https://quizbugs.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://quizbugs.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://quizbugs.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://quizbugs.preview.emergentagent.com/api/auth/google/callback"
```
