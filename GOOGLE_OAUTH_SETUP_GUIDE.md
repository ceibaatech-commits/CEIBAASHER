...
5. **Authorized JavaScript origins**: Add
   ```
   https://quizfeed.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://quizfeed.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://quizfeed.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://quizfeed.preview.emergentagent.com/api/auth/google/callback"
```
