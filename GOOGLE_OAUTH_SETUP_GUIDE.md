...
5. **Authorized JavaScript origins**: Add
   ```
   https://profilefix-3.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://profilefix-3.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://profilefix-3.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://profilefix-3.preview.emergentagent.com/api/auth/google/callback"
```
