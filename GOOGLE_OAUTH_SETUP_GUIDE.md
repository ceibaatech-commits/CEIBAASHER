...
5. **Authorized JavaScript origins**: Add
   ```
   https://socialsmart-1.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://socialsmart-1.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://socialsmart-1.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://socialsmart-1.preview.emergentagent.com/api/auth/google/callback"
```
