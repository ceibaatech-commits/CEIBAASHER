...
5. **Authorized JavaScript origins**: Add
   ```
   https://exam-crud-admin.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://exam-crud-admin.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://exam-crud-admin.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://exam-crud-admin.preview.emergentagent.com/api/auth/google/callback"
```
