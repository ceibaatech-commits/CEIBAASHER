...
5. **Authorized JavaScript origins**: Add
   ```
   https://profile-followers.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://profile-followers.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://profile-followers.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://profile-followers.preview.emergentagent.com/api/auth/google/callback"
```
