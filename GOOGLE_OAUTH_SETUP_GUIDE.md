...
5. **Authorized JavaScript origins**: Add
   ```
   https://quizhub-social.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://quizhub-social.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://quizhub-social.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://quizhub-social.preview.emergentagent.com/api/auth/google/callback"
```
