...
5. **Authorized JavaScript origins**: Add
   ```
   https://prep-notify.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://prep-notify.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://prep-notify.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://prep-notify.preview.emergentagent.com/api/auth/google/callback"
```
