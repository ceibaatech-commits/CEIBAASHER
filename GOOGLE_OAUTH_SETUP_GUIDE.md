...
5. **Authorized JavaScript origins**: Add
   ```
   https://battle-mode.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://battle-mode.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://battle-mode.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://battle-mode.preview.emergentagent.com/api/auth/google/callback"
```
