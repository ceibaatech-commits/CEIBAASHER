...
5. **Authorized JavaScript origins**: Add
   ```
   https://quizfix-2.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://quizfix-2.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://quizfix-2.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://quizfix-2.preview.emergentagent.com/api/auth/google/callback"
```
