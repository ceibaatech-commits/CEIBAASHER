...
5. **Authorized JavaScript origins**: Add
   ```
   https://banking-quiz-hub.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://banking-quiz-hub.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://banking-quiz-hub.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://banking-quiz-hub.preview.emergentagent.com/api/auth/google/callback"
```
