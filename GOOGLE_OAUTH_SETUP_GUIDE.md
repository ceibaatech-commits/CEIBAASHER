...
5. **Authorized JavaScript origins**: Add
   ```
   https://quizauth-pro.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://quizauth-pro.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://quizauth-pro.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://quizauth-pro.preview.emergentagent.com/api/auth/google/callback"
```
