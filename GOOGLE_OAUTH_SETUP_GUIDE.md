...
5. **Authorized JavaScript origins**: Add
   ```
   https://ceibaa-dev.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://ceibaa-dev.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://ceibaa-dev.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://ceibaa-dev.preview.emergentagent.com/api/auth/google/callback"
```
