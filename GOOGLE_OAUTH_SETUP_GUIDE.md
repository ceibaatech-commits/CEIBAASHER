...
5. **Authorized JavaScript origins**: Add
   ```
   https://examprep-cbse.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://examprep-cbse.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://examprep-cbse.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://examprep-cbse.preview.emergentagent.com/api/auth/google/callback"
```
