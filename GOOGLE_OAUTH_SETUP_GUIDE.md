...
5. **Authorized JavaScript origins**: Add
   ```
   https://ceibaa-preview.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://ceibaa-preview.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://ceibaa-preview.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://ceibaa-preview.preview.emergentagent.com/api/auth/google/callback"
```
