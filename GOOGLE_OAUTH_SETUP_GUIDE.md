...
5. **Authorized JavaScript origins**: Add
   ```
   https://battleroom-fix.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://battleroom-fix.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://battleroom-fix.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://battleroom-fix.preview.emergentagent.com/api/auth/google/callback"
```
