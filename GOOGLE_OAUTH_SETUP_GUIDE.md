...
5. **Authorized JavaScript origins**: Add
   ```
   https://quizloop.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://quizloop.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://quizloop.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://quizloop.preview.emergentagent.com/api/auth/google/callback"
```
