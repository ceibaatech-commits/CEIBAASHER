...
5. **Authorized JavaScript origins**: Add
   ```
   https://testextractor.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://testextractor.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://testextractor.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://testextractor.preview.emergentagent.com/api/auth/google/callback"
```
