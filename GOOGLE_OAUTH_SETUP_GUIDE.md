...
5. **Authorized JavaScript origins**: Add
   ```
   https://study-exam-makeover.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://study-exam-makeover.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://study-exam-makeover.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://study-exam-makeover.preview.emergentagent.com/api/auth/google/callback"
```
