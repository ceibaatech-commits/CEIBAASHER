...
5. **Authorized JavaScript origins**: Add
   ```
   https://exam-prep-kahoot.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://exam-prep-kahoot.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://exam-prep-kahoot.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://exam-prep-kahoot.preview.emergentagent.com/api/auth/google/callback"
```
