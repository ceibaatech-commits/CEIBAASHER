...
6. **Authorized redirect URIs**: Add
   ```
   https://mobile-search-fix-1.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://mobile-search-fix-1.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://mobile-search-fix-1.preview.emergentagent.com/api/auth/google/callback"
```
