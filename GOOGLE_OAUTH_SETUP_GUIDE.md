...
5. **Authorized JavaScript origins**: Add
   ```
   https://contenthub-30.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://contenthub-30.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://contenthub-30.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://contenthub-30.preview.emergentagent.com/api/auth/google/callback"
```
