...
5. **Authorized JavaScript origins**: Add
   ```
   https://social-feed-ceibaa.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://social-feed-ceibaa.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://social-feed-ceibaa.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://social-feed-ceibaa.preview.emergentagent.com/api/auth/google/callback"
```
