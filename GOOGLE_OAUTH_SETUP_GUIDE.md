...
5. **Authorized JavaScript origins**: Add
   ```
   https://feed-interact.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://feed-interact.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://feed-interact.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://feed-interact.preview.emergentagent.com/api/auth/google/callback"
```
