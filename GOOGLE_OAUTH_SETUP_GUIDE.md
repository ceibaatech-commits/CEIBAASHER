...
5. **Authorized JavaScript origins**: Add
   ```
   https://test-history-board.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://test-history-board.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://test-history-board.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://test-history-board.preview.emergentagent.com/api/auth/google/callback"
```
