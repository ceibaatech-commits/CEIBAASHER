...
5. **Authorized JavaScript origins**: Add
   ```
   https://smartquiz-render.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://smartquiz-render.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://smartquiz-render.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://smartquiz-render.preview.emergentagent.com/api/auth/google/callback"
```
