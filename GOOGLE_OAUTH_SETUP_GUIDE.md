...
5. **Authorized JavaScript origins**: Add
   ```
   https://socialfeed-fixes.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://socialfeed-fixes.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://socialfeed-fixes.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://socialfeed-fixes.preview.emergentagent.com/api/auth/google/callback"
```
