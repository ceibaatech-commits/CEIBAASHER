...
6. **Authorized redirect URIs**: Add
   ```
   https://profile-social-4.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://profile-social-4.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://profile-social-4.preview.emergentagent.com/api/auth/google/callback"
```
