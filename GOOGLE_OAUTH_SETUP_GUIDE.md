...
5. **Authorized JavaScript origins**: Add
   ```
   https://ceibaafix.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://ceibaafix.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://ceibaafix.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://ceibaafix.preview.emergentagent.com/api/auth/google/callback"
```
