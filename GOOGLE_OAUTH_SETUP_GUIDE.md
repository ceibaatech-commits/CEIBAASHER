...
5. **Authorized JavaScript origins**: Add
   ```
   https://joinquiz-debug.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://joinquiz-debug.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://joinquiz-debug.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://joinquiz-debug.preview.emergentagent.com/api/auth/google/callback"
```
