...
5. **Authorized JavaScript origins**: Add
   ```
   https://quiz-switch.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://quiz-switch.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://quiz-switch.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://quiz-switch.preview.emergentagent.com/api/auth/google/callback"
```
