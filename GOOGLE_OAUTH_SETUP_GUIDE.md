...
6. **Authorized redirect URIs**: Add
   ```
   https://ceibaa-integration.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://ceibaa-integration.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://ceibaa-integration.preview.emergentagent.com/api/auth/google/callback"
```
