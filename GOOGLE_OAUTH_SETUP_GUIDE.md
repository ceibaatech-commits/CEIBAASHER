...
5. **Authorized JavaScript origins**: Add
   ```
   https://uioverhaul.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://uioverhaul.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://uioverhaul.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://uioverhaul.preview.emergentagent.com/api/auth/google/callback"
```
