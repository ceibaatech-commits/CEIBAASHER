...
5. **Authorized JavaScript origins**: Add
   ```
   https://post-animation-test.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://post-animation-test.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://post-animation-test.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://post-animation-test.preview.emergentagent.com/api/auth/google/callback"
```
