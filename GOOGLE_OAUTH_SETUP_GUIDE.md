...
5. **Authorized JavaScript origins**: Add
   ```
   https://socialeq-hub.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://socialeq-hub.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://socialeq-hub.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://socialeq-hub.preview.emergentagent.com/api/auth/google/callback"
```
