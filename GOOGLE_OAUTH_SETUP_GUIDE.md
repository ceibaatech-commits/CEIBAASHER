...
5. **Authorized JavaScript origins**: Add
   ```
   https://quizzen-3.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://quizzen-3.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://quizzen-3.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://quizzen-3.preview.emergentagent.com/api/auth/google/callback"
```
