...
5. **Authorized JavaScript origins**: Add
   ```
   https://live-quiz-hub.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://live-quiz-hub.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://live-quiz-hub.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://live-quiz-hub.preview.emergentagent.com/api/auth/google/callback"
```
