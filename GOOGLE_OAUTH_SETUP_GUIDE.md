...
5. **Authorized JavaScript origins**: Add
   ```
   https://quizroom-revival.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://quizroom-revival.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://quizroom-revival.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://quizroom-revival.preview.emergentagent.com/api/auth/google/callback"
```
