...
5. **Authorized JavaScript origins**: Add
   ```
   https://exam-sync.preview.emergentagent.com
   ```
6. **Authorized redirect URIs**: Add
   ```
   https://exam-sync.preview.emergentagent.com/api/auth/google/callback
   ```
7. Click **"CREATE"**
...
1. Go to https://exam-sync.preview.emergentagent.com/login
...
GOOGLE_CALLBACK_URL="https://exam-sync.preview.emergentagent.com/api/auth/google/callback"
```
